...

{
	...
	const ajv = new Ajv2020({ schemas: [manifestSchema, looseManifestSchema], code: { source: true, esm: true } })
	const moduleCode = standaloneCode(ajv, { ModuleManifest: '/assets/manifest.schema.json' })
